...
/**
 * SlopeOne Test Case corresponds to SlopeOneRedommender
 * {@link net.librec.recommender.ext.SlopeOneRecommender}
 *
 * @author Liuxz
 */
public class SlopeOneTestCase extends BaseTestCase {
	@Override
	@Before
