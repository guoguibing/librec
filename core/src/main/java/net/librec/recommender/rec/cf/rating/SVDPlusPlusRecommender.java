...
public class SVDPlusPlusRecommender extends BiasedMFRecommender {
            ...
            for (MatrixEntry matrixEntry : trainMatrix) {
                ...
                for (int factorIdx = 0; factorIdx < numFactors; ++factorIdx) {
                    ...
                    for (int impItemIdx : items) {
                        ...
                        impItemFactors.add(impItemIdx, factorIdx, learnRate * (error * itemFactorValue / impNor - regUser * impItemFactor));
    ...
    protected double predict(int userIdx, int itemIdx) throws LibrecException {
        ...
        double impNor = Math.sqrt(userItemsList.get(userIdx).size());
        if (impNor > 0) {
