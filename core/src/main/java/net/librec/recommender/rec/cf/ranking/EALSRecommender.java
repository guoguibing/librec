...
public class EALSRecommender extends MatrixFactorizationRecommender {
    protected float alpha; // for WRMF
    ...
    protected void setup() throws LibrecException {
        ...
        overallWeight = conf.getFloat("rec.eals.overall", 128);
        WRMFJudge = conf.getInt("rec.eals.wrmfJudge", 0);
...
//            System.out.println("wrmf:"+wrmf);
        ...
        for (MatrixEntry matrixEntry : trainMatrix) {
            ...
            if (WRMFJudge == 1 || WRMFJudge == 2) {
                weights.set(userIdx, itemIdx, 1.0 + alpha * matrixEntry.get());
//                w.set(u, i, 1.0 + Math.log(1.0 + Math.pow(10, alpha) * me.get()));
            } else {
