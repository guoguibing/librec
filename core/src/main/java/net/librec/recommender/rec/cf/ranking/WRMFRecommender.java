...
public class WRMFRecommender extends MatrixFactorizationRecommender {
    ...
    protected SparseMatrix confindenceMinusIdentityMatrix;//confindenceMinusIdentityMatrix{ui} = confidenceMatrix_{ui} - 1 =alpha * r_{ui} or log(1+10^alpha * r_{ui})
    protected SparseMatrix preferenceMatrix;//preferenceMatrix_{ui} = 1 if r_{ui}>0 or preferenceMatrix_{ui} = 0

    @Override
    protected void setup() throws LibrecException {
        super.setup();
        alpha = conf.getFloat("rec.wrmf.alpha", 0.01f);
...
//            confindenceMinusIdentityMatrix.set(userIdx, itemIdx, Math.log(1.0 + Math.pow(10, alpha) * me.get()));
    ...
    protected void trainModel() throws LibrecException {
        ...
        DenseMatrix X = userFactors, Y = userFactors;
