...
/**
 * A <tt>SocialDataFeature</tt> is a class to process and store social feature
 * data.
 *
 * @author SunYatong
 */
public class SocialDataFeature extends Configured implements DataFeature {
    ...
    /** The path of the feature data file */
    ...
    /**
     * Initializes a newly created {@code SocialDataFeature} object with null.
     */
    public SocialDataFeature() {
        this(null);
    }

    /**
     * Initializes a newly created {@code SocialDataFeature} object with a
     * {@code Configuration} object
     *
     * @param conf  {@code Configuration} object for construction
     */
    public SocialDataFeature(Configuration conf) {
        this.conf = conf;
    }
    ...
    public void processData() throws IOException {
        if (conf != null && StringUtils.isNotBlank(conf.get("data.feature.path"))) {
            inputDataPath = conf.get("dfs.data.dir") + "/" + conf.get("data.feature.path");
