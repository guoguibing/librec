...
public class DenseMatrix implements DataMatrix, Serializable {
	 ...
	 */
	public DenseMatrix addEqual(DenseMatrix mat) {
		assert numRows == mat.numRows;
		assert numColumns == mat.numColumns;
	 ...
	 * @return this matrix with results of {@code A = A + B}
	 */
	public DenseMatrix addEqual(SparseMatrix mat) {
		assert numRows == mat.numRows;
		assert numColumns == mat.numColumns;
	 ...
	 * @return this matrix with results of {@code A = A - B}
	 */
	public DenseMatrix minusEqual(DenseMatrix mat) {
		assert numRows == mat.numRows;
		assert numColumns == mat.numColumns;
	 ...
	 */
	public DenseMatrix minusEqual(SparseMatrix mat) {
		assert numRows == mat.numRows;
		assert numColumns == mat.numColumns;
