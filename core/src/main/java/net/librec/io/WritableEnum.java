...
public enum WritableEnum {
    ...
    public static WritableEnum getWritableEnum(Object o) {
        ...
        if (o instanceof LongWritable || o instanceof Long) {
            ...
            return DENSEMATRIX;
        } else if (o instanceof SparseVectorWritable || o instanceof SequentialAccessSparseMatrix) {
            return SPARSEVECTOR;
        } else if (o instanceof SparseMatrixWritable || o instanceof SequentialAccessSparseMatrix) {
            return SPARSEMATRIX;
