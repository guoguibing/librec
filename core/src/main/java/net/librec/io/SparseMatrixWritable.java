...
public class SparseMatrixWritable implements Writable {
     ...
     */
    private SequentialAccessSparseMatrix value;
     ...
     */
    public SparseMatrixWritable(SequentialAccessSparseMatrix sparseMatrix) {
...
//            out.writeInt(value.rowSize());
//            out.writeInt(value.columnSize());
...
//                }
    ...
    public void setValue(Object value) {
        this.value = (SequentialAccessSparseMatrix) value;
    }
