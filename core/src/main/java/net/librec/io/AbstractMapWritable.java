...
public abstract class AbstractMapWritable implements Writable {
    ...
    /**
     * Used to plus "predefined" classes and by Writable to copy "new" classes.
     */
    ...
    public void write(DataOutput out) throws IOException {
        ...
        // First write out the cardinality of the class table and any classes that are
        // "unknown" classes
    ...
    public void readFields(DataInput in) throws IOException {
        ...
        // Then read in the class names and plus them to our tables
