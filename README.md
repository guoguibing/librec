...
Links: [Get Started](http://www.librec.net/tutorial.html), [Examples](http://librec.net/example.html), [Datasets](http://www.librec.net/datasets.html), [Source Code](https://github.com/guoguibing/librec). 
