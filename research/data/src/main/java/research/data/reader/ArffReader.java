...
public class ArffReader {
     ...
     * Log
     */
    private static final Log LOG = LogFactory.getLog(ArffReader.class);
    /**
    ...
    public ArffReader(String path, ArrayList<BiMap<String, Integer>> featureMapping) {
        this(path);
     ...
     */
    public DataSet readData(String... inputDataPath) throws IOException {
            ...
            if (0 == i) { //read the first file
                ...
                while (true) {
                    ...
                    // parse ATTRIBUTE
                        ...
                        BiMap<String, Integer> colId = DataSet.getInnerMapping(attrName);
        ...
        for (int i = 0; i < attributes.size(); i++) {
            attributes.get(i).setColumnSet(DataSet.getInnerMapping(attributes.get(i).getName()).keySet());
        }
                        ...
                        for (int i = 0; i < dataLine.size(); i++) {
                            ...
                            switch (type) {
                                ...
                                case "INTEGER":
                                    break;
                                case "STRING":
                                    DataSet.setId(col, attributes.get(i).getName());
                                    break;
                                case "NOMINAL":
                                    BiMap<String, Integer> colId = DataSet.getInnerMapping(attributes.get(i).getName());
    ...
    public BiMap<String, Integer> getUserIds() {
        return DataSet.getInnerMapping("user");
    }
    ...
    public BiMap<String, Integer> getItemIds() {
        return DataSet.getInnerMapping("item");
    }
