...
package research.model.utils;

import research.model.math.algorithm.Randoms;
...
public class Lists {
     ...
     */
    public static <K, V extends Comparable<? super V>> List<Entry<K, V>> sortMap(Map<K, V> data,
                                                                                     final boolean inverse) {

        // According to tests, LinkedList is slower than ArrayList
        List<Entry<K, V>> pairs = new ArrayList<>(data.entrySet());
     ...
     * @param inverse descending if true; otherwise ascending
     */
    public static <K, V extends Comparable<? super V>> void sortList(List<Entry<K, V>> data, final boolean inverse) {

        Collections.sort(data, new Comparator<Entry<K, V>>() {
     ...
     * @param inverse descending if true; otherwise ascending
     */
    public static <K extends Comparable<? super K>, V extends Comparable<? super V>> void sortListByKey(List<Entry<K, V>> data, final boolean inverse) {
     ...
     * @param data map data
     */
    public static <K, V extends Comparable<? super V>> void sortList(List<Entry<K, V>> data) {
        sortList(data, false);
    }
     ...
     */
    public static <K, V extends Comparable<? super V>> List<Entry<K, V>> sortListTopK(List<Entry<K, V>> data, final boolean inverse, int k) {
        ...
        PriorityQueue<Entry<K, V>> topKDataQueue = new PriorityQueue<>(k, new Comparator<Entry<K, V>>() {
            public int compare(Entry<K, V> a, Entry<K, V> b) {
                int res = (a.getValue()).compareTo(b.getValue());
                return inverse ? res : -res;
            }
        ...
        Iterator<Entry<K, V>> iterator = data.iterator();
        for (int i = 0; i < k; i++) {
        ...
        List<Entry<K, V>> topKDataList = new ArrayList<>(topKDataQueue);
     ...
     */
    public static <K, V extends Comparable<? super V>> List<Entry<K, V>> sortList(List<Entry<K, V>> data, int k) {
