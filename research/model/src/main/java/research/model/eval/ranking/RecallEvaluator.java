 ...
 * @author Keqiang Wang
 */
public class RecallEvaluator extends AbstractRecommenderEvaluator<IntCollection> {
    ...
    public double evaluate(IntCollection itemIdSetInTest, List<KeyValue> recommendedList){
        int itemIndexSize = itemIdSetInTest.size();
        int numHits = 0;
        ...
        return itemIndexSize>0 ? numHits / (itemIndexSize + 0.0): 0.0d;
    }
}
